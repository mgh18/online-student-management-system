...
namespace SMS.Controllers
{
    ...
    public class CoursesStudentController : Controller
    {
        ...
        //    IEnumerable<Course> courses = db.Teaches.Where(c => c.SectionId == SecID ).Select(x => x.Course);
        ...
        //    var assesments = db.Assesments.Where(a => a.CourseID == id  &&  a.DeadLine >= today);
        //    if (assesments == null)
        //    {
        //        return HttpNotFound();
        //    }
        ...
        //    String date = DateTime.Now.ToString("yyyy-MM-dd");
        //    DateTime today = DateTime.Parse(date);
        //    var assesments = db.Assesments.Where(a =>  a.DeadLine >= today);
        //    if (assesments == null)
        //    {
        //        return HttpNotFound();
        //    }
